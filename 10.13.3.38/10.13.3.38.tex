...
\end{enumerate} 
\textbf{Solution:} Let, $X$ be the random variable that represent the number of heads appearing on dices.
\begin{table}[h]
	\centering
	\input{tables/table} 
...
\end{table} 
\begin{align}
\label{eq:pr-pts/1}\pr{X_i} &=
	\begin{cases}
		\frac{1}{8} & \text{,i=0 heads comes in 3 tosses}\\
		\frac{3}{8} & \text{,i=1 heads comes in 3 tosses}\\
		\frac{3}{8} & \text{,i=2 heads comes in 3 tosses}\\
		\frac{1}{8} & \text{,i=3 heads comes in 3 tosses}
	\end{cases}
\end{align}
