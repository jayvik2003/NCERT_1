...
\end{enumerate} 
\textbf{Solution:} Let, $X_i$ be the sequence of independent Bernoulli random varibles and the total number of trials be n and $Z$ be the random variable that represents the number of tails in n trials which is given by:
\begin{align}
p_X\brak{Z} = \comb{n}{k}p^{n-k}q^{k}
\end{align}
\begin{table}[h]
	\centering
	\input{tables/table} 
