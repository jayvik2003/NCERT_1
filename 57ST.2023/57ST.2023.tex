...
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{1}{\sqrt{2\pi\brak{\frac{1}{\sqrt{n}}}}}e^{-\frac{\brak{x-0}^2}{2\brak{\frac{1}{\sqrt{n}}}}} \,dx \\
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{\sqrt[4]{n}}{\sqrt{2\pi}}e^{-\frac{\brak{\sqrt[4]{n}x}^2}{2}} \,dx \\
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{1}{\sqrt{2\pi}}e^{-\frac{\brak{x}^2}{2}} \,dx \\
&=F_Z(x)
\end{align}
where, $Z \sim \mathcal{N}(0,1)$ \\
...
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{1}{\sqrt{2\pi\brak{\frac{1}{n}}}}e^{-\frac{\brak{x-\frac{1}{n}}^2}{2\brak{\frac{1}{n}}}} \,dx \\
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{n}{\sqrt{2\pi}}e^{-\frac{\brak{n^2x-n}^2}{2}} \,dx \\
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{1}{\sqrt{2\pi}}e^{-\frac{\brak{nx-n}^2}{2}} \,dx \\
&= 0
\end{align}
Thus, $Y_n +\frac{1}{n} \xrightarrow{d} 0 \implies Y_n +\frac{1}{n} \xrightarrow{p} 0$ \\
Note: This condition is only true for converges at real constants. \\
Hence, option (C) is correct.
\item let $\{X_n\}_{n \geq 1}$ almost surely converges to $0$.
Then, $X_n \xrightarrow{p} 1$.
\begin{align}
lim_{n \to \infty} F_{X_n} 
&= lim_{n \to \infty} \int_{-\infty}^{+\infty} \frac{1}{\sqrt{2\pi\brak{1}}}e^{\frac{-\brak{x-0}^2}{2\brak{1}^2}} \,dx \\
&= 0 \\
X_n \xrightarrow{d} 0 \\
