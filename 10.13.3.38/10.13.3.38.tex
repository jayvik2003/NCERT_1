...
\end{enumerate} 
\textbf{Solution:} Let, $X_i$ and $Y_i$ be the sequence of independent Bernoulli random variables and the total number of trials be n and $Z$ be the random variable that represents the number of tails in n trials which is given by:
\begin{align}
...
\begin{table}[h]
    ...
    \label{tab:exemplar/10/13/3/38}
\end{table} \\
Probability that she loses the entry fees,
\begin{align}
	p_X(Z = 1) 
...
\end{align}
Probability that she gets double entry fees,
\begin{align}
	p_Y(Z = 1) 
 		&= \comb{3}{3}\brak{\frac{1}{2}}^{3-3}\brak{\frac{1}{2}}^{3} \\
 		&= \brak{\frac{1}{2}}^{3} \\
		\label{eq:pr-pts/8}&= 0.125 
\end{align}
Probability that she just gets the entry fees,
\begin{align}
\pr{Y=0 | X=0} &= 1 - p_X(Z=0) - p_X(Z=1) \\
&= 1 - 0.125 - 0.125 \\
