...
\label{eq:9.3.6/3}&= 0.4096
\end{align}
Let Y be gaussian variable
\begin{align}
\label{eq:9.3.6/4}\mu&=np\\
&=4
\end{align}
\begin{align}
\label{eq:9.3.6/6}\sigma^2&=npq\\
&=\frac{4}{5}
\end{align}
Using Normal distribution at $X=4$.
\begin{align}
\label{eq:9.3.6/8}Z &= \frac{X-\mu}{\sigma}\\
&=\frac{4-4}{\sqrt{\frac{4}{5}}}\\
&=0
\end{align}
For pdf calculation
\begin{align}
\label{eq:9.3.6/11} f_Y(x)&=\frac{1}{\sqrt{2\pi\sigma^2}}e^{-\frac{(x-\mu)^2}{2\sigma^2}}
\end{align}
\begin{figure}[!ht]
\centering
...
\begin{align}
p_Y(4)&=p_Z(0)\\
\label{eq:9.3.6/13}&=0.44603
\end{align}
From \eqref{eq:9.3.6/3} and \eqref{eq:9.3.6/13},
\begin{align}
p_X(4)\approx p_Y(4)
\end{align}
