...
\begin{table}[h]
	\input{/home/jay/Desktop/ncert1/65EC.2023/tables/table.tex}
\end{table} \\
\textbf{Solution:}
\begin{table}[h]
	\input{/home/jay/Desktop/ncert1/65EC.2023/tables/tab_ans.tex}
\end{table} 
\begin{align}
...
We start from a frequency of $1$ and distribute it uniformly.
The following conventions is used,
\begin{table}[h]
	\input{/home/jay/Desktop/ncert1/65EC.2023/tables/tab_huff2.tex}
\end{table} \\
\begin{tikzpicture}[thin,level/.style={sibling distance=50mm/#1}]
\node[label={\small 1}{ ,a }](a){$\frac{1} {2}$} child
{
...
\begin{table}[h]
	\input{/home/jay/Desktop/ncert1/65EC.2023/tables/tab_huff.tex}
