...
\end{enumerate} 
\textbf{Solution:} Let, $X$ represent the number of heads appearing on dices.
\begin{table}[h]
	\centering
	\input{tables/table} 
...
X_i &=
	\begin{cases}
		\frac{1}{8} & \text{0 heads comes in 3 tosses}\\
		\frac{3}{8} & \text{1 heads comes in 3 tosses}\\
		\frac{3}{8} & \text{2 heads comes in 3 tosses}\\
		\frac{1}{8} & \text{3 heads comes in 3 tosses}
	\end{cases}
\end{align}
From table \eqref{tab:exemplar/10/13/3/38} we can say, \\
