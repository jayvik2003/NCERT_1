...
\hhline{|-|-|-}
	...
	{\gnumericPB{\centering}\gnumbox{denoted}}
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{not loses the entry fees}}
\\
\hhline{~|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{loses the entry fees}}
\\
\hhline{|---|}
	 \hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\gnumericPB{\centering}\gnumbox{0}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{not gets double entry fees}}
\\
\hhline{~|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	...
	{\gnumericPB{\centering}\gnumbox{1}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{gets double entry fees}}
\\
\hhline{|-|-|-|}
\end{tabular}
