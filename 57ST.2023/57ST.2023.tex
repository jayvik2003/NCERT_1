...
&\label{65/st/23:eq5}\implies Var(Y_n)=1
\end{align}
\begin{enumerate}[label=(\Alph*)]
\item For $\{\sqrt{n}Y_n\}_{n \geq 1}$ to converges in distribution to a standard normal random variable ,
\begin{align}
lim_{n \to \infty} F_{\sqrt{n}Y_n}(x) = 0
\end{align}
\begin{align}
lim_{n \to \infty} F_{\sqrt{n}Y_n}(x) 
&= lim_{n \to \infty} \frac{1}{\sqrt{n}}F_{{\brak{X_1X_2}}}(x) + \\&  ... + \frac{1}{\sqrt{n}}F_{{\brak{X_2nX_{2n-1}}}}(x) \\
&= lim_{n \to \infty} \frac{1}{\sqrt{n}}F_{X_1}(x)F_{X_2}(x) + \\&  ... + \frac{1}{\sqrt{n}}F_{X_{2n}}(x)F_{X_{2n-1}}(x) \\ 
&\because F_{X_{i}} = F_{X_{i+1}} , X_{i} \sim \mathcal{N}(0,1) \\
&= lim_{n \to \infty} \sqrt{n}\brak{\frac{1}{\sqrt{2\pi}}e^{x^2}} \\
&= 0
\end{align}
